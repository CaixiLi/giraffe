...
<head>
	...
	<link href="/metronic/theme/assets/global/plugins/clockface/css/clockface.css" rel="stylesheet" type="text/css" />
	<!-- END PAGE LEVEL PLUGINS -->
	<!-- BEGIN PAGE LEVEL PLUGINS -->
	...
	<link href="/metronic/theme/assets/layouts/layout3/css/layout.min.css" rel="stylesheet" type="text/css" />
	<link href="/metronic/theme/assets/layouts/layout3/css/themes/default.min.css" rel="stylesheet" type="text/css" id="style_color" />
	<link href="/metronic/theme/assets/layouts/layout3/css/custom.min.css" rel="stylesheet" type="text/css" />
...
<div class="page-header">
	...
	<div class="page-header-top">
		<div class="container">
			...
			<div class="page-logo">
				<a href="/index">
					<img src="/logo/phoenix.png" alt="logo" >
				</a>
			</div>
			<!-- END LOGO -->
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user dropdown-dark">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
							<img alt="" class="img-circle" src="${sessionScope.login.photo}">
							<span class="username username-hide-mobile">${sessionScope.login.cnName}</span>
						</a>
					</li>
					...
					<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
						...
						<ul class="media-list list-items">
							<li class="media">
								...
								<img class="media-object" src="/metronic/theme/assets/layouts/layout/img/avatar3.jpg" alt="/metronic/theme.">
							...
							<li class="media">
								<img class="media-object" src="/metronic/theme/assets/layouts/layout/img/avatar1.jpg" alt="/metronic/theme.">
								<div class="media-body">
							...
							<li class="media">
								...
								<img class="media-object" src="/metronic/theme/assets/layouts/layout/img/avatar4.jpg" alt="/metronic/theme.">
								<div class="media-body">
							...
							<li class="media">
								<img class="media-object" src="/metronic/theme/assets/layouts/layout/img/avatar2.jpg" alt="/metronic/theme.">
								<div class="media-body">
						...
						<ul class="media-list list-items">
							<li class="media">
								...
								<img class="media-object" src="/metronic/theme/assets/layouts/layout/img/avatar6.jpg" alt="/metronic/theme.">
								<div class="media-body">
							...
							<li class="media">
								...
								<img class="media-object" src="/metronic/theme/assets/layouts/layout/img/avatar7.jpg" alt="/metronic/theme.">
								<div class="media-body">
							...
							<li class="media">
								<img class="media-object" src="/metronic/theme/assets/layouts/layout/img/avatar8.jpg" alt="/metronic/theme.">
								<div class="media-body">
							...
							<li class="media">
								...
								<img class="media-object" src="/metronic/theme/assets/layouts/layout/img/avatar9.jpg" alt="/metronic/theme.">
								<div class="media-body">
							...
							<li class="media">
								<img class="media-object" src="/metronic/theme/assets/layouts/layout/img/avatar10.jpg" alt="/metronic/theme.">
								<div class="media-body">
							...
							<li class="media">
								...
								<img class="media-object" src="/metronic/theme/assets/layouts/layout/img/avatar11.jpg" alt="/metronic/theme.">
								<div class="media-body">
					...
					<div class="page-quick-sidebar-item">
						<div class="page-quick-sidebar-chat-user">
							...
							<div class="page-quick-sidebar-chat-user-form">
								<div class="input-group">
									<input type="text" class="form-control" placeholder="Type a message here/metronic/theme.">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-3 col-sm-6 col-xs-12 footer-block">
				<address class="margin-bottom-40"> 使用中有任何问题请联系李核
				<address class="margin-bottom-40"> MOMO: 36616290
				<address class="margin-bottom-40"> Phone: 18600800129
					<br> Email:
					<a href="mailto:li.he@immomo.com">li.he@immomo.com</a>
				</address>
			</div>
		</div>
	</div>
...
<script src="/metronic/theme/assets/layouts/layout3/scripts/layout.min.js" type="text/javascript"></script>
<script src="/metronic/theme/assets/layouts/layout3/scripts/demo.min.js" type="text/javascript"></script>
...
<script src="/metronic/theme/assets/global/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js" type="text/javascript"></script>
<script src="/metronic/theme/assets/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
<script src="/metronic/theme/assets/global/plugins/clockface/js/clockface.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
